...
export const useTemplateConfig = () => {
  ...
  const fetchTemplateConfigs = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        'http://localhost:5002/api/template-configs',
        {
          method: 'GET',
          headers: {
  ...
  const saveTemplateConfig = async (configData) => {
    ...
    try {
      const response = await fetch(
        'http://localhost:5002/api/save-template-config',
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${authToken}`,
  ...
  const uploadLogo = async (file) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5002/api/upload-logo', {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
  ...
  const setDefaultTemplate = async (templateId) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5002/api/template-configs/${templateId}/set-default`,
        {
          method: 'PUT',
          headers: {
            Authorization: `Bearer ${authToken}`,
  ...
  const deleteTemplateConfig = async (templateId) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5002/api/template-configs/${templateId}`,
        {
          method: 'DELETE',
          headers: {
            Authorization: `Bearer ${authToken}`,
  ...
  const getTemplatePreview = async (templateId) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5002/api/template-preview/${templateId}`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${authToken}`,
