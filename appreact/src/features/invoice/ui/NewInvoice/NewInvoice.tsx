...
import { Paper, Typography, Container, Fab, Stack } from '@mui/material';
...
const StyledFab = styled(Fab)<{ customVariant?: string }>(
  ({ customVariant }) => ({
    background:
      customVariant === 'preview'
          ...
          <Container maxWidth='lg'>
            ...
            >
              ...
              <Stack direction='row' spacing={2}>
                <ReactToPrint
                  trigger={() => (
                    <StyledFab customVariant='print' size='medium'>
                      <Print />
                    </StyledFab>
                  )}
