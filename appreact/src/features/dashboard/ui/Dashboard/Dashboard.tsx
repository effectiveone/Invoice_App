...
const HeaderSection = styled(Box)(({ theme }: { theme?: StyledTheme }) => ({
  display: 'flex',
  alignItems: 'center',
  marginBottom: '32px',
  padding: '24px',
...
const LoadingCard = styled(Card)(({ theme }: { theme?: StyledTheme }) => ({
  borderRadius: '16px',
...
const NoDataCard = styled(Card)(({ theme }: { theme?: StyledTheme }) => ({
  borderRadius: '16px',
  boxShadow: '0 4px 20px rgba(0, 0, 0, 0.08)',
  background: 'linear-gradient(145deg, #ffffff 0%, #f8fafc 100%)',
  textAlign: 'center',
